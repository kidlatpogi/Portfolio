...
export const ChatBot: React.FC = () => {
  ...
  const topics = [
    ...
    {
      label: '💼 Services & Cost',
      query: 'What services do you offer and how much?',
      response: 'Zeus specializes in full-stack web engineering, custom AI integrations, and mobile development. Pricing depends on project size and timeline. Click the Connect button in the header navigation to start a conversation!'
    },
    {
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="bg-black text-[#FAFAFA] p-4 flex items-center justify-between border-b border-[#334155]/10">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-mono text-[9px] uppercase tracking-wider text-[#FAFAFA]/70 mt-0.5">About & Experience</span>
                </div>
              </div>
              <button
            ...
            {/* Messages Container */}
            <div className="h-[280px] overflow-y-auto p-4 flex flex-col gap-3 bg-[#FAFAFA]">
              {messages.map((msg) => (
                <div
                  key={msg.id}
              ...
              <div className="flex flex-wrap gap-2">
                {topics.map((t, idx) => (
                  <button
                    ...
                    className="font-mono text-[10px] font-semibold rounded-full border border-[#334155] px-3 py-1.5 text-[#334155] bg-transparent cursor-pointer transition-colors duration-200 hover:bg-[#334155] hover:text-[#FAFAFA]"
                  >
                    {t.label}
                  </button>
                ))}
