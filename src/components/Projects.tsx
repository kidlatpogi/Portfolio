      ...
      <div className="w-[95%] md:w-[95%] max-w-[1600px] mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="lg:w-[320px] xl:w-[380px] flex-shrink-0 lg:sticky lg:top-[15vh] lg:self-start">
            {/* Section Label */}
            <span className="font-mono text-[11px] md:text-xs font-semibold uppercase tracking-[0.25em] text-[#334155] block mb-4">
              Selected Projects
            </span>

            {/* Section Title */}
            <h2 className="font-clash-semibold text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.5rem] font-semibold text-black tracking-tighter leading-[0.9] select-none mb-6">
              Featured<br />Work
            </h2>
