...
export default function About() {
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 py-12 sm:py-16 md:py-24 relative overflow-hidden bg-transparent z-10" id="about">
      ...
      <div className="w-full max-w-[1600px] flex flex-col items-center z-10">
        ...
        {/* "About" Heading */}
        <h2 className="font-clash-semibold text-4xl sm:text-5xl md:text-6xl lg:text-[3.5rem] xl:text-[4.25rem] 2xl:text-[5rem] font-semibold text-accent tracking-tighter leading-[0.9] select-none whitespace-nowrap text-center mb-8 sm:mb-12">
          About
        </h2>

        {/* Main Narrative Paragraph with ScrollReveal */}
        <div className="w-[95%] md:w-[95%] max-w-[2000px] flex justify-center mx-auto mb-10 sm:mb-14">
          <ScrollReveal
            baseOpacity={0.08}
            enableBlur={false}
            baseRotation={2}
            blurStrength={12}
            textClassName="text-black font-sans text-left tracking-normal leading-relaxed text-base sm:text-xl md:text-2xl lg:text-3xl"
          ...
          >
            ...
            <span className="inline-flex items-center gap-1.5 sm:gap-2 align-middle">
              <img
                ...
                className="w-8 h-8 sm:w-12 sm:h-12 md:w-16 md:h-16 rounded-full border-2 sm:border-[2.5px] border-accent object-cover shadow-sm"
              />
            ...
            <span className="inline-flex items-center gap-1 sm:gap-1.5 text-accent font-bold align-middle">
              patterns
              <Sparkles className="w-4 h-4 sm:w-6 sm:h-6 md:w-7 md:h-7 text-accent" />
            </span>
            ...
            <span className="inline-flex items-center gap-1.5 sm:gap-2 text-accent align-middle font-bold">
              <Cpu className="w-4 h-4 sm:w-6 sm:h-6 md:w-7 md:h-7 text-accent animate-pulse" />
              who loves building
            </span>{' '}
        ...
        <div className="w-[95%] md:w-[95%] max-w-[1600px] grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mx-auto">
          ...
          <div className="border-2 border-slate-200/80 bg-white p-5 sm:p-7 md:p-8 rounded-2xl sm:rounded-3xl flex flex-col justify-start gap-2 sm:gap-3 hover:border-accent hover:shadow-[0_12px_28px_-8px_rgba(196,73,0,0.1)] transition-all duration-300 group cursor-target">
            ...
            <div className="grid grid-cols-2 gap-2.5 sm:gap-3 mt-1">
              <div className="p-3 sm:p-4 bg-slate-50 rounded-xl sm:rounded-2xl border border-slate-100">
                ...
                <p className="font-mono text-[9px] sm:text-xs text-slate-500 uppercase font-semibold leading-tight mt-1">
