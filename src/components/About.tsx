      ...
      <div className="w-full max-w-[1600px] flex flex-col items-center z-10">
        ...
        <div className="w-[95%] md:w-[95%] max-w-[2000px] flex justify-center mx-auto mb-14">
          <ScrollReveal
            ...
            baseRotation={2}
            blurStrength={12}
            textClassName="text-black font-sans text-left tracking-normal leading-relaxed text-lg sm:text-xl md:text-2xl lg:text-3xl"
          ...
          <div className="border-2 border-slate-200/80 bg-white p-7 md:p-8 rounded-3xl flex flex-col justify-start gap-3 hover:border-accent hover:shadow-[0_12px_28px_-8px_rgba(196,73,0,0.1)] transition-all duration-300 group cursor-target">
            ...
            <div className="grid grid-cols-2 gap-3 mt-1">
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <span className="font-clash-semibold text-3xl font-bold text-accent">12+</span>
                <p className="font-mono text-xs text-slate-500 uppercase font-semibold leading-tight mt-1">
                  Verified Badges & Certifications
                </p>
              </div>
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                <span className="font-clash-semibold text-3xl font-bold text-accent">8+</span>
                <p className="font-mono text-xs text-slate-500 uppercase font-semibold leading-tight mt-1">
